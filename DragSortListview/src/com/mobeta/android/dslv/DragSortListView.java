...
public class DragSortListView extends ListView {
    ...
    public void setItemCheckedChangedListener(ItemCheckedChangedListener l) {
        this.mItemCheckedChangedListener = l;
    }

    @Override
    public boolean performItemClick(View view, int position, long id) {
        final boolean result = super.performItemClick(view, position, id);
        if (mItemCheckedChangedListener != null) {
            mItemCheckedChangedListener.onItemCheckedChanged(position, isItemChecked(position));
        }
        return result;
    }
    ...
    public void setItemChecked(int position, boolean value) {
        ...
        if (mItemCheckedChangedListener != null) {
            mItemCheckedChangedListener.onItemCheckedChanged(position, value);
        }
    }
    ...
    public void clearChoices() {
        super.clearChoices();
        if (mItemCheckedChangedListener != null) {
            mItemCheckedChangedListener.onItemCheckedChanged(-1, false);
        }
    }
