 ...
 */
public final class IndexFutureQuoteDialogQuoteDialog extends Dialog implements IQuoteDialog,
    ...
    public IndexFutureQuoteDialogQuoteDialog(@NonNull Context context, SecurityDetailPresenter presenter) {
        super(context, R.style.dialog_center_theme);
        setContentView(R.layout.dialog_index_future_quote);
    ...
    public void updateQuote(final SecQuote quote) {
        ...
        mText52.setText(String.valueOf((int)quote.fDayincrease));
        ...
        mText72.setText(StringUtil.getHandicapString(quote.lOutside, false, true, false, suspended));
        mText74.setText(StringUtil.getHandicapString(quote.lInside, false, true, false, suspended));
        if (quote.lOutside > 0) {
            mText72.setTextColor(StringUtil.getColorRed());
        } else {
            mText72.setTextColor(ContextCompat.getColor(getContext(), R.color.default_text_color_100));
        }
        if (quote.lInside > 0) {
            mText74.setTextColor(StringUtil.getColorGreen());
        } else {
            mText74.setTextColor(ContextCompat.getColor(getContext(), R.color.default_text_color_100));
        }
        mText82.setText(StringUtil.getAppointString(quote));
        mText84.setText(String.valueOf(quote.lVolinstock));
    }
