...
import com.sscf.investment.detail.presenter.HongKongQuotePresenter;
import com.sscf.investment.detail.presenter.SecurityDetailPresenter;
import com.sscf.investment.detail.view.AHPremiumLayout;
 ...
 */
public final class HongKongQuoteDialog extends Dialog implements IQuoteDialog, DialogInterface.OnDismissListener, View.OnClickListener {
    ...
    private HongKongQuotePresenter mQuotePresenter;

    public HongKongQuoteDialog(@NonNull Context context, SecurityDetailPresenter presenter) {
        super(context, R.style.dialog_center_theme);
        setContentView(R.layout.dialog_hongkong_quote);
        ...
        mAHLayout.setOnClickListener(this);
        mAHLayout.setType(AHPremiumLayout.SEC_TYPE_HONGKONG);

        StatisticsUtil.reportAction(StatisticsConst.SECURITY_DETAIL_SHOW_QUOTE_DETAIL);
    }

    public void setQuotePresenter(HongKongQuotePresenter quotePresenter) {
        this.mQuotePresenter = quotePresenter;
    }
    ...
    public void updateQuote(final SecQuote quote) {
        ...
        mAHLayout.setHQuote(StockUtil.getSimpleQuoteFromQuote(quote));
    }

    public void updateAHpremuim(final SecSimpleQuote aQuote) {
        mAHLayout.setVisibility(VISIBLE);
        mAHLayout.setAQuote(aQuote);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.close_button:
                ...
                break;
            case R.id.ahLayout:
                mQuotePresenter.clickShowAHPremium(getContext());
                dismiss();
                break;
            default:
                break;
