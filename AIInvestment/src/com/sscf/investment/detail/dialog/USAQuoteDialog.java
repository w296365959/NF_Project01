 ...
 */
public final class USAQuoteDialog extends Dialog implements IQuoteDialog,
    ...
    public USAQuoteDialog(@NonNull Context context, SecurityDetailPresenter presenter) {
        super(context, R.style.dialog_center_theme);
        setContentView(R.layout.dialog_usa_quote);
    ...
    public void updateQuote(final SecQuote quote) {
        ...
        mText72.setText(StringUtil.getTradableSharesString(quote));
        mText74.setText(StringUtil.getAmountString(quote.fCirculationmarketvalue));
        mText82.setText(StringUtil.getTotalSharesString(quote));
        mText84.setText(StringUtil.getAmountString(quote.fTotalmarketvalue));
        mText92.setText(StringUtil.getPeString(quote.fSyl));
    }
