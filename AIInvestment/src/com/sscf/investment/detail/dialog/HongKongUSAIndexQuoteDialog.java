 ...
 */
public final class HongKongUSAIndexQuoteDialog extends Dialog implements IQuoteDialog,
    ...
    public HongKongUSAIndexQuoteDialog(@NonNull Context context, SecurityDetailPresenter presenter) {
        super(context, R.style.dialog_center_theme);
        setContentView(R.layout.dialog_hongkong_usa_index_quote);
