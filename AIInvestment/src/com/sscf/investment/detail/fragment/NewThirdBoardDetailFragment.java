...
public class NewThirdBoardDetailFragment extends SecurityDetailFragment implements OperationBar.OnOperationListener,
        DetailActionBar.OnOperationListener, View.OnClickListener, ISecurityDetailView {

    private static final String TAG = NewThirdBoardDetailFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        DtLog.d(TAG, "onCreateView: mDtSecCode = " + mDtSecCode);
        super.onCreateView(inflater, container, savedInstanceState);
        View contextView = getActivity().getLayoutInflater().inflate(R.layout.main_new_third_board_stock_detail, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.quoteLayout:
                mPresenter.showNewThirdBoardQuoteDialog(activity);
