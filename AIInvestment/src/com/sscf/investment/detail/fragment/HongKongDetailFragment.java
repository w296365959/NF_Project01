 ...
 *
 */
public final class HongKongDetailFragment extends SecurityDetailFragment implements DetailActionBar.OnOperationListener,
        OperationBar.OnOperationListener, View.OnClickListener, ISecurityDetailView {
    private static final String TAG = HongKongDetailFragment.class.getSimpleName();
            ...
            if (TradingStateManager.ACTION_MARKET_TRADING_STATE_CHANGED.equals(action)) {
                ...
                if (marketType == mMarketType) {
                    ...
                    mIsTrading = (tradingState == TradingStateManager.TRADING_STATE_TRADING
                            || tradingState == TradingStateManager.TRADING_STATE_CALLAUCTION);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View contextView = getActivity().getLayoutInflater().inflate(R.layout.main_hongkong_stock_detail, container, false);
    ...
    private void showDelayPromptIfNeed() {
        ...
        dialog.setMessage(R.string.hongkong_delay_prompt_msg);
    ...
    public void updateBaseInfoView(SecBaseInfoRsp baseInfoRsp) {
        ...
        attrTags.add(activity.getString(R.string.hongkong_delay_actionbar_tag));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.quoteLayout:
                mPresenter.showHongKongQuoteDialog(activity, mName);
