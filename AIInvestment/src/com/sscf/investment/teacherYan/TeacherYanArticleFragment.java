...
import com.sscf.investment.teacherYan.adapter.TeacherYanArticleAdapter;
import com.sscf.investment.teacherYan.presenter.TeacherYanArticlePresent;
...
public class TeacherYanArticleFragment extends BaseFragment implements View.OnClickListener,
        RecyclerViewManager.OnLoadMoreListener, TeacherYanFragment.OnPullRefresh{

    private static final String TAG = "TeacherYanArticleFragment";

    private TeacherYanArticlePresent mPresenter;

    private RecyclerView mRecyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    private RecyclerViewManager mRecyclerViewManager;
    private TeacherYanArticleAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView(root);
        mPresenter = new TeacherYanArticlePresent(this);
        return root;
    }
    ...
    private void initView(View view) {
        ...
        mAdapter = new TeacherYanArticleAdapter(getActivity());
    ...
    public void updateList(ArrayList<WxTeachTitle> pVideos) {
