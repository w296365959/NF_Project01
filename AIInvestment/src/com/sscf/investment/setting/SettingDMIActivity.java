...
public class SettingDMIActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_dmi);
        mKlineSettingManager = DengtaApplication.getApplication().getKLineSettingManager();
        mIndicatorConfigure = mKlineSettingManager.getConfigureByName("DMI");
    ...
    private void initViews() {
        ((TextView) findViewById(R.id.actionbar_title)).setText(R.string.index_type_dmi);
        ...
        mSeekBarLayout1 = (SeekBarLayout) findViewById(R.id.settingDMI1);
        mSeekBarLayout1.setText(textLeft, maxLength, textRight);
        mSeekBarLayout1.setValueRange(1, 300);
        mSeekBarLayout1.setValue(Integer.valueOf(strValues[0]));

        mSeekBarLayout2 = (SeekBarLayout) findViewById(R.id.settingDMI2);
        mSeekBarLayout2.setText(textLeft, maxLength, textRight);
        mSeekBarLayout2.setValueRange(1, 300);
        mSeekBarLayout2.setValue(Integer.valueOf(strValues[1]));

        ((TextView) findViewById(R.id.title)).setText(R.string.index_type_dmi);

        new Handler().postDelayed(new Runnable() { // 解决三星s6 edge更换字体后字体被截断的问题
            @Override
            public void run() {
                ((TextView) findViewById(R.id.intro)).setText(R.string.setting_dmi_intro);
            }
        }, 0L);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.actionbar_right_button:
                mSeekBarLayout1.setValue(SettingConst.DEFAULT_SETTING_DMI_1);
                mSeekBarLayout2.setValue(SettingConst.DEFAULT_SETTING_DMI_2);
                break;
            default:
                break;
        }
