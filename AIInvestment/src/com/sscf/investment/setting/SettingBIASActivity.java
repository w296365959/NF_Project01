...
public class SettingBIASActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_bias);
        mKlineSettingManager = DengtaApplication.getApplication().getKLineSettingManager();
        mIndicatorConfigure = mKlineSettingManager.getConfigureByName("BIAS");
    ...
    private void initViews() {
        ((TextView) findViewById(R.id.actionbar_title)).setText(R.string.index_type_bias);
        ...
        mSeekBarLayout1 = (SeekBarLayout) findViewById(R.id.settingBIAS1);
        ...
        mSeekBarLayout2 = (SeekBarLayout) findViewById(R.id.settingBIAS2);
        ...
        mSeekBarLayout3 = (SeekBarLayout) findViewById(R.id.settingBIAS3);
        ...
        ((TextView) findViewById(R.id.title)).setText(R.string.index_type_bias);

        new Handler().postDelayed(new Runnable() { // 解决三星s6 edge更换字体后字体被截断的问题
            @Override
            public void run() {
                ((TextView) findViewById(R.id.intro)).setText(R.string.setting_bias_intro);
            }
        }, 0L);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.actionbar_right_button:
                mSeekBarLayout1.setValue(SettingConst.DEFAULT_SETTING_BIAS_1);
                mSeekBarLayout2.setValue(SettingConst.DEFAULT_SETTING_BIAS_2);
                mSeekBarLayout3.setValue(SettingConst.DEFAULT_SETTING_BIAS_3);
                break;
            default:
                break;
        }
