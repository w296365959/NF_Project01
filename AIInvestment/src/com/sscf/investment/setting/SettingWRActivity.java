...
public class SettingWRActivity  extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_wr);
        mKlineSettingManager = DengtaApplication.getApplication().getKLineSettingManager();
        mIndicatorConfigure = mKlineSettingManager.getConfigureByName("WR");
    ...
    private void initViews() {
        ((TextView) findViewById(R.id.actionbar_title)).setText(R.string.index_type_wr);
        ...
        mSeekBarLayout1 = (SeekBarLayout) findViewById(R.id.settingWR);
        ...
        ((TextView) findViewById(R.id.title)).setText(R.string.index_type_wr);

        new Handler().postDelayed(new Runnable() { // 解决三星s6 edge更换字体后字体被截断的问题
            @Override
            public void run() {
                ((TextView) findViewById(R.id.intro)).setText(R.string.setting_wr_intro);
            }
        }, 0L);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.actionbar_right_button:
                mSeekBarLayout1.setValue(SettingConst.DEFAULT_SETTING_WR);
                break;
            default:
                break;
        }
