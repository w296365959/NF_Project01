...
public class SettingENEActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_ene);
        mKlineSettingManager = DengtaApplication.getApplication().getKLineSettingManager();
        mIndicatorConfigure = mKlineSettingManager.getConfigureByName("ENE");
    ...
    private void initViews() {
        ((TextView) findViewById(R.id.actionbar_title)).setText(R.string.index_type_ene);
        ...
        mSeekBarLayout1 = (SeekBarLayout) findViewById(R.id.settingENE1);
        mSeekBarLayout1.setText(textLeft, maxLength, textRight);
        mSeekBarLayout1.setValueRange(2, 120);
        mSeekBarLayout1.setValue(Integer.valueOf(strValues[0]));

        mSeekBarLayout2 = (SeekBarLayout) findViewById(R.id.settingENE2);
        mSeekBarLayout2.setText(textLeft, maxLength, textRight);
        mSeekBarLayout2.setValueRange(2, 120);
        mSeekBarLayout2.setValue(Integer.valueOf(strValues[1]));

        mSeekBarLayout3 = (SeekBarLayout) findViewById(R.id.settingENE3);
        mSeekBarLayout3.setText(textLeft, maxLength, textRight);
        mSeekBarLayout3.setValueRange(2, 120);
        mSeekBarLayout3.setValue(Integer.valueOf(strValues[2]));

        ((TextView) findViewById(R.id.title)).setText(R.string.index_type_ene);

        new Handler().postDelayed(new Runnable() { // 解决三星s6 edge更换字体后字体被截断的问题
            @Override
            public void run() {
                ((TextView) findViewById(R.id.intro)).setText(R.string.setting_ene_intro);
            }
        }, 0L);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.actionbar_right_button:
                mSeekBarLayout1.setValue(SettingConst.DEFAULT_SETTING_ENE_1);
                mSeekBarLayout2.setValue(SettingConst.DEFAULT_SETTING_ENE_2);
                mSeekBarLayout3.setValue(SettingConst.DEFAULT_SETTING_ENE_3);
                break;
            default:
                break;
        }
