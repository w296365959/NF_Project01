 ...
 * 投顾榜单界面管理器，adapter
 */
public final class InvestmentAdviserListManager extends CommonRecyclerViewAdapter implements
    ...
    public InvestmentAdviserListManager(Context context, LongSparseArray<Boolean> attentionsStates, int type, long accountId) {
        super(context);
        ...
        mLoadingLayoutCenter = root.findViewById(R.id.loading_layout);
        mFailRetryLayoutCenter = root.findViewById(R.id.fail_retry);
        ...
        mRecyclerViewManager = new RecyclerViewManager(context, mRecyclerView, linearLayoutManager,
                this, mLoadingLayoutCenter, mFailRetryLayoutCenter, emptyView, this);

        mRecyclerViewManager.showRecyclerViewByState(DengtaConst.UI_STATE_LOADING);
        mRecyclerViewManager.showFooterViewByState(DengtaConst.UI_STATE_NO_FOOTER);
    }
    ...
    final class FriendHolder extends CommonViewHolder {
        ...
        public void onItemClicked() {
            ...
            if (item != null) {
                ...
                StatisticsUtil.reportAction(StatisticsConst.INVESTMENT_ADVISER_LIST_CLICK_INVESTMENT_ADVISER);
            }
        }
    ...
    public void requestData() {
        FeedRequestManager.getInvestmentAdviserListRequest(mStartId, mType, this);
    }

    public void requestData(String startId) {
        mStartId = startId;
        FeedRequestManager.getInvestmentAdviserListRequest(startId, mType, this);
    }
...
//                mRecyclerViewManager.showFooterViewByState(DengtaConst.UI_STATE_FAILED_RETRY);
    ...
    public void updateList(final EntityObject data) {
        ...
        final ArrayList<FeedUserBaseInfo> list = rsp.vFeedUserBaseInfo;
