...
//        DtLog.d(TAG, "onMeasure: mVideoWidth = " + mVideoWidth + ", mVideoHeight = " + mVideoHeight);
//        DtLog.d(TAG, "onMeasure: width = " + width + ", height = " + height + ", specWidthSize = " + specWidthSize + ", specHeightSize = " + specHeightSize);
//        setMeasuredDimension(width, height); //保留这一行就是视频保持原宽高比
        //By liqingfeng 视频不保持原来的宽高比，始终缩放为View的内容区大小
...
//        am.requestAudioFocus(null, AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_GAIN);
        ...
        try {
            ...
            DtLog.w(TAG, "Unable to open content: " + mUri, ex);
            ...
            DtLog.w(TAG, "Unable to open content: " + mUri, t);
            DtLog.d(TAG, "openVideo: Exception: " + t.getMessage());
            mCurrentState = STATE_ERROR;
            mTargetState = STATE_ERROR;
            mErrorListener.onError(mMediaPlayer, MediaPlayer.MEDIA_ERROR_UNKNOWN, 0);
        }
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
            new MediaPlayer.OnErrorListener() {
                public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                    DtLog.d(TAG, "Error: " + framework_err + "," + impl_err);
                    mCurrentState = STATE_ERROR;
                    mTargetState = STATE_ERROR;
                    if (mMediaController != null) {
                        mMediaController.hide();
    ...
    TextureView.SurfaceTextureListener mSurfaceTextureListener = new SurfaceTextureListener()
    {
        ...
        public void onSurfaceTextureAvailable(final SurfaceTexture surface, final int width, final int height) {
            ...
            mBgColor = getContext().getResources().getColor(R.color.splash_bg_default);

//            clearBackground(); //不马上画空白背景的话,在小米和华为手机上back返回时会黑一下
