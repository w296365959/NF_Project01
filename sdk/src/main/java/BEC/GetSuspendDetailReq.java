...
public final class GetSuspendDetailReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetSuspendDetailReq()
    {
    }

    public GetSuspendDetailReq(UserInfo stUserInfo, java.util.ArrayList<String> vDtCode)
    {
        this.stUserInfo = stUserInfo;
        this.vDtCode = vDtCode;
    }
