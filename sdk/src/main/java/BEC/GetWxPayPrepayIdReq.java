...
public final class GetWxPayPrepayIdReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetWxPayPrepayIdReq()
    {
    }

    public GetWxPayPrepayIdReq(UserInfo stUserInfo, AccountTicket stAccountTicket, String sDtPayOrderId, String sPassback, String sAppId)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.sDtPayOrderId = sDtPayOrderId;
