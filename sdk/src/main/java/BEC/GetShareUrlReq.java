...
public final class GetShareUrlReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetShareUrlReq()
    {
    }

    public GetShareUrlReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iType)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iType = iType;
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.iType = (int)istream.readInt32(2, false, this.iType);
    }
