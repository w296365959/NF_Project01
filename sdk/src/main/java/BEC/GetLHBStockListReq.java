...
public final class GetLHBStockListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetLHBStockListReq()
    {
    }

    public GetLHBStockListReq(UserInfo stUserInfo, String sDay)
    {
        this.stUserInfo = stUserInfo;
        this.sDay = sDay;
    }
