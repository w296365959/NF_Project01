...
public final class StockHaveMarginReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public StockHaveMarginReq()
    {
    }

    public StockHaveMarginReq(BEC.UserInfo stUserInfo, java.util.ArrayList<String> vtDtSecCode)
    {
        this.stUserInfo = stUserInfo;
        this.vtDtSecCode = vtDtSecCode;
    }
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        if (null != vtDtSecCode) {
            ostream.writeList(1, vtDtSecCode);
        }
    }
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.vtDtSecCode = (java.util.ArrayList<String>)istream.readList(1, false, VAR_TYPE_4_VTDTSECCODE);
    }
