...
public final class ConditionPickStrategyListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public ConditionPickStrategyListReq()
    {
    }

    public ConditionPickStrategyListReq(UserInfo stUserInfo, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
