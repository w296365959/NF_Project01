...
public final class VideoInfoListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public VideoInfoListReq()
    {
    }

    public VideoInfoListReq(int iBeginID, int iCount)
    {
        this.iBeginID = iBeginID;
        this.iCount = iCount;
    }
