...
public final class GetLiveReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetLiveReq(UserInfo stUserInfo, int iType, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.iType = iType;
        this.stAccountTicket = stAccountTicket;
