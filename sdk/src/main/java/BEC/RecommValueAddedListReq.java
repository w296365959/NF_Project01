...
public final class RecommValueAddedListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public RecommValueAddedListReq()
    {
    }

    public RecommValueAddedListReq(UserInfo stUserInfo, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
