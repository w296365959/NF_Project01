...
public final class LikeUserReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public LikeUserReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iSscfInfoID, int eInfoType)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iSscfInfoID = iSscfInfoID;
