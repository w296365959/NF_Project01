...
public final class VerfiyThirdAccountRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public VerfiyThirdAccountRsp()
    {
    }

    public VerfiyThirdAccountRsp(BEC.AccountTicket stAccountTicket, BEC.AccountInfo stAccountInfo, java.util.ArrayList<BEC.ThirdLoginInfo> vtThirdLoginInfo)
    {
        this.stAccountTicket = stAccountTicket;
        this.stAccountInfo = stAccountInfo;
        this.vtThirdLoginInfo = vtThirdLoginInfo;
