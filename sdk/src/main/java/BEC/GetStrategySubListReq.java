...
public final class GetStrategySubListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetStrategySubListReq()
    {
    }

    public GetStrategySubListReq(UserInfo stUserInfo, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
