...
public final class GetRealTimeHotStockReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    private static final long serialVersionUID = 1L;

    public UserInfo stUserInfo = null;

    public int iWantNum = 50;
    ...
    public GetRealTimeHotStockReq()
    {
    }

    public GetRealTimeHotStockReq(UserInfo stUserInfo, int iWantNum)
    {
        this.stUserInfo = stUserInfo;
        this.iWantNum = iWantNum;
    }
