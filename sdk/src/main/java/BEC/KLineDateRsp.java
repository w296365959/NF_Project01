...
public final class KLineDateRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public KLineDateRsp(java.util.ArrayList<BEC.KLineDesc> vKLineDesc, int eKLineType)
    {
        this.vKLineDesc = vKLineDesc;
        this.eKLineType = eKLineType;
    }
