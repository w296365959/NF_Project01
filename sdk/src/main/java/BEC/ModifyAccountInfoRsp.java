...
public final class ModifyAccountInfoRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public ModifyAccountInfoRsp()
    {
    }

    public ModifyAccountInfoRsp(BEC.AccountTicket stAccountTicket, BEC.AccountInfo stAccountInfo, java.util.ArrayList<BEC.ThirdLoginInfo> vtThirdLoginInfo)
    {
        this.stAccountTicket = stAccountTicket;
        this.stAccountInfo = stAccountInfo;
        this.vtThirdLoginInfo = vtThirdLoginInfo;
