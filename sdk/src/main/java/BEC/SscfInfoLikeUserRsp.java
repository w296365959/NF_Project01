...
public final class SscfInfoLikeUserRsp extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public SscfInfoLikeUserRsp()
    {
    }

    public SscfInfoLikeUserRsp(int iCount, boolean isLike)
    {
        this.iCount = iCount;
        this.isLike = isLike;
    }
