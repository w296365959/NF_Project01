...
public final class PhoneIndexValue extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public PhoneIndexValue()
    {
    }

    public PhoneIndexValue(long iAccountId)
    {
        this.iAccountId = iAccountId;
    }
