...
public final class GetAccuPointUserInviteReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetAccuPointUserInviteReq()
    {
    }

    public GetAccuPointUserInviteReq(UserInfo stUserInfo, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
