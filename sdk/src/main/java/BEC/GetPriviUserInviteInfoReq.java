...
public final class GetPriviUserInviteInfoReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetPriviUserInviteInfoReq()
    {
    }

    public GetPriviUserInviteInfoReq(UserInfo stUserInfo, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
