...
public final class DiscoveryNewsIdListRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public DiscoveryNewsIdListRsp()
    {
    }

    public DiscoveryNewsIdListRsp(java.util.ArrayList<BEC.NewsDesc> vtId, String sNextNewsID)
    {
        this.vtId = vtId;
        this.sNextNewsID = sNextNewsID;
    }
