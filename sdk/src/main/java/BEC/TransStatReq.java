...
public final class TransStatReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public TransStatReq(BEC.UserInfo stUserInfo, String sDtSecCode, int iStartxh, int iWantnum)
    {
        this.stUserInfo = stUserInfo;
        this.sDtSecCode = sDtSecCode;
        this.iStartxh = iStartxh;
