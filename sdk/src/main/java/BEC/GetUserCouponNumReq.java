...
public final class GetUserCouponNumReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public int getICouponStatus()
    {
        return iCouponStatus;
    }

    public void  setICouponStatus(int iCouponStatus)
    {
        this.iCouponStatus = iCouponStatus;
    }

    public GetUserCouponNumReq()
    {
    }

    public GetUserCouponNumReq(BEC.UserInfo stUserInfo, BEC.AccountTicket stAccountTicket, int iCouponStatus)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iCouponStatus = iCouponStatus;
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        ostream.writeInt32(2, iCouponStatus);
    }
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.iCouponStatus = (int)istream.readInt32(2, false, this.iCouponStatus);
    }
