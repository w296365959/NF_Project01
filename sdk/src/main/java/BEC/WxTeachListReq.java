...
public final class WxTeachListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public WxTeachListReq()
    {
    }

    public WxTeachListReq(int iBeginID, int iCount)
    {
        this.iBeginID = iBeginID;
        this.iCount = iCount;
    }
