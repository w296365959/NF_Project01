...
public final class UserNameIndexValue extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public UserNameIndexValue()
    {
    }

    public UserNameIndexValue(long iAccountId)
    {
        this.iAccountId = iAccountId;
    }
