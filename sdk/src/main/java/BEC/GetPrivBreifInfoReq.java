...
public final class GetPrivBreifInfoReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetPrivBreifInfoReq()
    {
    }

    public GetPrivBreifInfoReq(UserInfo stUserInfo, java.util.ArrayList<String> vDtCode)
    {
        this.stUserInfo = stUserInfo;
        this.vDtCode = vDtCode;
    }
