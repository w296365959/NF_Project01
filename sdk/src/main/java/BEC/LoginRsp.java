...
public final class LoginRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    private static final long serialVersionUID = 1L;

    public BEC.AccountTicket stAccountTicket = null;

    public BEC.VerifyCode stMachineVerfiyCode = null;
    ...
    public BEC.VerifyCode getStMachineVerfiyCode()
    {
        return stMachineVerfiyCode;
    }

    public void  setStMachineVerfiyCode(BEC.VerifyCode stMachineVerfiyCode)
    {
        this.stMachineVerfiyCode = stMachineVerfiyCode;
    }
    ...
    public LoginRsp(BEC.AccountTicket stAccountTicket, BEC.VerifyCode stMachineVerfiyCode, BEC.AccountInfo stAccountInfo, java.util.ArrayList<BEC.ThirdLoginInfo> vtThirdLoginInfo)
    {
        this.stAccountTicket = stAccountTicket;
        this.stMachineVerfiyCode = stMachineVerfiyCode;
        this.stAccountInfo = stAccountInfo;
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        if (null != stMachineVerfiyCode) {
            ostream.writeMessage(1, stMachineVerfiyCode);
        }
        if (null != stAccountInfo) {
            ostream.writeMessage(2, stAccountInfo);
        }
        if (null != vtThirdLoginInfo) {
            ostream.writeList(3, vtThirdLoginInfo);
        }
    }

    static BEC.AccountTicket VAR_TYPE_4_STACCOUNTTICKET = new BEC.AccountTicket();

    static BEC.VerifyCode VAR_TYPE_4_STMACHINEVERFIYCODE = new BEC.VerifyCode();
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.stMachineVerfiyCode = (BEC.VerifyCode)istream.readMessage(1, false, VAR_TYPE_4_STMACHINEVERFIYCODE);
        this.stAccountInfo = (BEC.AccountInfo)istream.readMessage(2, false, VAR_TYPE_4_STACCOUNTINFO);
        this.vtThirdLoginInfo = (java.util.ArrayList<BEC.ThirdLoginInfo>)istream.readList(3, false, VAR_TYPE_4_VTTHIRDLOGININFO);
    }
