...
public final class SecPolicyNXInfoDateReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public SecPolicyNXInfoDateReq()
    {
    }

    public SecPolicyNXInfoDateReq(UserInfo stUserInfo, int iDate)
    {
        this.stUserInfo = stUserInfo;
        this.iDate = iDate;
    }
