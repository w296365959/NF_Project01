...
public final class TickReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public TickReq(String sDtSecCode, int iStartxh, int iWantnum, byte [] vGuid)
    {
        this.sDtSecCode = sDtSecCode;
        this.iStartxh = iStartxh;
        this.iWantnum = iWantnum;
