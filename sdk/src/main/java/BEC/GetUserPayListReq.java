...
public final class GetUserPayListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetUserPayListReq()
    {
    }

    public GetUserPayListReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iDirection, String sStartId)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iDirection = iDirection;
