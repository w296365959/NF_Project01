...
public final class QqIdIndexValue extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public QqIdIndexValue()
    {
    }

    public QqIdIndexValue(long iAccountId)
    {
        this.iAccountId = iAccountId;
    }
