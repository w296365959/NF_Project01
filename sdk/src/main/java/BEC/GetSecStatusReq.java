...
public final class GetSecStatusReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetSecStatusReq()
    {
    }

    public GetSecStatusReq(UserInfo stUserInfo, java.util.ArrayList<String> vDtCode)
    {
        this.stUserInfo = stUserInfo;
        this.vDtCode = vDtCode;
    }
