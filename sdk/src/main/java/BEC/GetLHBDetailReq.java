...
public final class GetLHBDetailReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetLHBDetailReq()
    {
    }

    public GetLHBDetailReq(UserInfo stUserInfo, String sDtSecCode, String sDay)
    {
        this.stUserInfo = stUserInfo;
        this.sDtSecCode = sDtSecCode;
        this.sDay = sDay;
