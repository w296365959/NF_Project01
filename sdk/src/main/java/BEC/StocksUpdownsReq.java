...
public final class StocksUpdownsReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public StocksUpdownsReq()
    {
    }

    public StocksUpdownsReq(java.util.ArrayList<String> vtDtSecCode)
    {
        this.vtDtSecCode = vtDtSecCode;
    }
