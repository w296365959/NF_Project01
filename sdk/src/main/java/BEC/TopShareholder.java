...
public final class TopShareholder extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public TopShareholder(String sName, String sRatio, int eShareholderChange, String sChangeDetail, String sUniCode)
    {
        this.sName = sName;
        this.sRatio = sRatio;
        this.eShareholderChange = eShareholderChange;
