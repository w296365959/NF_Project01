...
public final class ExpertInfoListReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public ExpertInfoListReq()
    {
    }

    public ExpertInfoListReq(int iBeginID, int iCount)
    {
        this.iBeginID = iBeginID;
        this.iCount = iCount;
    }
