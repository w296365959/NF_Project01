...
public final class CommitInvitePassReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public CommitInvitePassReq()
    {
    }

    public CommitInvitePassReq(UserInfo stUserInfo, String sInvitePass, AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.sInvitePass = sInvitePass;
        this.stAccountTicket = stAccountTicket;
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        if (null != sInvitePass) {
            ostream.writeString(1, sInvitePass);
        }
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.sInvitePass = (String)istream.readString(1, false, this.sInvitePass);
