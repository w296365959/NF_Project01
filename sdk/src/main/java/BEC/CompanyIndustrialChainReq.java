...
public final class CompanyIndustrialChainReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public CompanyIndustrialChainReq()
    {
    }

    public CompanyIndustrialChainReq(UserInfo stUserInfo, String sDtSecCode)
    {
        this.stUserInfo = stUserInfo;
        this.sDtSecCode = sDtSecCode;
    }
