...
public final class OrderList extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public OrderList(java.util.Map<String, BEC.PayInfo> mPayInfo)
    {
        this.mPayInfo = mPayInfo;
    }
