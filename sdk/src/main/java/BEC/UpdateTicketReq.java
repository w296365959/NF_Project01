...
public final class UpdateTicketReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public UpdateTicketReq(BEC.UserInfo stUserInfo, long iAccountId, BEC.AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.iAccountId = iAccountId;
        this.stAccountTicket = stAccountTicket;
