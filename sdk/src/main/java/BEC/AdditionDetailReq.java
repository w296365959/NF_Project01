...
public final class AdditionDetailReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public AdditionDetailReq()
    {
    }

    public AdditionDetailReq(java.util.ArrayList<String> vDtSecCode, BEC.UserInfo stUserInfo)
    {
        this.vDtSecCode = vDtSecCode;
        this.stUserInfo = stUserInfo;
    }
