...
public final class UserMap extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public UserMap(java.util.Map<Integer, UserInfo> stAccountId)
    {
        this.stAccountId = stAccountId;
    }
