...
public final class GetUserPointDetailReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetUserPointDetailReq()
    {
    }

    public GetUserPointDetailReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iDirection, String sStartId)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iDirection = iDirection;
