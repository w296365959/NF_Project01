...
public final class FaverateVideoReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public FaverateVideoReq()
    {
    }

    public FaverateVideoReq(BEC.UserInfo stUserInfo, BEC.AccountTicket stAccountTicket)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
    }
