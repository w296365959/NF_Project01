...
public final class WxTeachInfo extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public WxTeachInfo(int iID, int iTID, int iSourceID, String sTitle, String sTitleImage, String sInformationTime, String sContent, String sReadCount, String sLaudCount)
    {
        this.iID = iID;
        this.iTID = iTID;
        this.iSourceID = iSourceID;
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        if (null != sContent) {
            ostream.writeString(6, sContent);
        }
        if (null != sReadCount) {
            ostream.writeString(7, sReadCount);
        }
        if (null != sLaudCount) {
            ostream.writeString(8, sLaudCount);
        }
    }
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.sContent = (String)istream.readString(6, false, this.sContent);
        this.sReadCount = (String)istream.readString(7, false, this.sReadCount);
        this.sLaudCount = (String)istream.readString(8, false, this.sLaudCount);
    }
