...
public final class ReportFinishTaskReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public ReportFinishTaskReq()
    {
    }

    public ReportFinishTaskReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iTaskType)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iTaskType = iTaskType;
    ...
    public void write(com.dengtacj.thoth.BaseEncodeStream eos)
    {
        ...
        ostream.writeInt32(2, iTaskType);
    }
    ...
    public void read(com.dengtacj.thoth.BaseDecodeStream dos)
    {
        ...
        this.iTaskType = (int)istream.readInt32(2, false, this.iTaskType);
    }
