...
public final class GetGoldenStockSwitchReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetGoldenStockSwitchReq()
    {
    }

    public GetGoldenStockSwitchReq(UserInfo stUserInfo, int iType)
    {
        this.stUserInfo = stUserInfo;
        this.iType = iType;
    }
