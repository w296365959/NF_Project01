...
public final class GetIPODetailInfoReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetIPODetailInfoReq()
    {
    }

    public GetIPODetailInfoReq(UserInfo stUserInfo, String sDtSecCode)
    {
        this.stUserInfo = stUserInfo;
        this.sDtSecCode = sDtSecCode;
    }
