...
public final class SetLoginDayReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public SetLoginDayReq()
    {
    }

    public SetLoginDayReq(UserInfo stUserInfo, AccountTicket stAccountTicket, int iType)
    {
        this.stUserInfo = stUserInfo;
        this.stAccountTicket = stAccountTicket;
        this.iType = iType;
