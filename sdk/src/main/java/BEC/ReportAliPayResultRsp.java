...
public final class ReportAliPayResultRsp extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public ReportAliPayResultRsp()
    {
    }

    public ReportAliPayResultRsp(int iPayStatus)
    {
        this.iPayStatus = iPayStatus;
    }
