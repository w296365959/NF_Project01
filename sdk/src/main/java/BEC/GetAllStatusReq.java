...
public final class GetAllStatusReq extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public GetAllStatusReq()
    {
    }

    public GetAllStatusReq(UserInfo stUserInfo, int iStatus)
    {
        this.stUserInfo = stUserInfo;
        this.iStatus = iStatus;
    }
