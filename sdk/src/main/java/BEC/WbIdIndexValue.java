...
public final class WbIdIndexValue extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public WbIdIndexValue()
    {
    }

    public WbIdIndexValue(long iAccountId)
    {
        this.iAccountId = iAccountId;
    }
