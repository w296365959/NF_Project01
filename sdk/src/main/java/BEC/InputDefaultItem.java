...
public final class InputDefaultItem extends com.dengtacj.thoth.Message implements Cloneable, java.io.Serializable
{
    ...
    public InputDefaultItem(String sSentence)
    {
        this.sSentence = sSentence;
    }
