...
public final class SecBaseInfoReq extends com.dengtacj.thoth.Message implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public SecBaseInfoReq()
    {
    }

    public SecBaseInfoReq(BEC.UserInfo stUserInfo, java.util.ArrayList<String> vDtSecCode)
    {
        this.stUserInfo = stUserInfo;
        this.vDtSecCode = vDtSecCode;
    }
